    ...
    def __init__(self, n_actions):
        super(MyFcn_trained, self).__init__(
            ...
            conv8_pi=chainerrl.policies.SoftmaxPolicy(
                L.Convolution2D(64, n_actions, 3, stride=1, pad=1, nobias=False, initialW=None)),
...
class MyFcn_d(chainer.Chain, a3c.A3CModel):
    ...
    def __init__(self, n_actions):
        ...
        chainer.serializers.load_npz('./denoise_model/pretrained.npz', net)
        super(MyFcn_d, self).__init__(
            # conv1=L.Convolution2D( 1, 64, 3, stride=1, pad=1, nobias=False, initialW=net.layer1.W.data, initial_bias=net.layer1.b.data),
            conv1=L.Convolution2D(1, 64, 3, stride=1, pad=1, nobias=False, initialW=net.conv1.W.data,
            ...
            conv8_pi=chainerrl.policies.SoftmaxPolicy(
                L.Convolution2D(64, n_actions, 3, stride=1, pad=1, nobias=False, initialW=net.conv8_pi.model.W.data,
            ...
            conv7_V=L.Convolution2D(64, 1, 3, stride=1, pad=1, nobias=False, initialW=net.conv7_V.W.data,
