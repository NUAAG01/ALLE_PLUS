...
def main():
    folder_GT = 'D:\Image_Enhancement_code\Aesthetic-guided LLE\LOL/gt/'
    folder_Gen = 'D:\Image_Enhancement_code\ALL-E/result/denoise_nima_t/6/'
    crop_border = 4
    suffix = '_'  # suffix for Gen images
    ...
    for i, img_path in enumerate(img_list_Gen):

        im_Gen = cv2.imread(img_path) / 255.
        im_GT = cv2.imread(img_list_GT[i])/255.
        print(img_path)
        print(img_list_GT[i])
